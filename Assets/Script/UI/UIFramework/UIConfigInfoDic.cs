...
public class UIConfigInfoDic
{
    ...
    public static Dictionary<Type, UIConfigInfo> configDic = new Dictionary<Type, UIConfigInfo>()
    {
        ...
        {typeof(LobbyUI), new UIConfigInfo() { resId =  ResIds.LobbyUI , showLayer = UIShowLayer.Floor_0}},
        {typeof(HeroListUI), new UIConfigInfo() { resId =  ResIds.HeroListUI , showLayer = UIShowLayer.Floor_0}},
        {typeof(HeroInfoUI), new UIConfigInfo() { resId =  ResIds.HeroInfoUI , showLayer = UIShowLayer.Floor_0}},
        {typeof(BattleUI), new UIConfigInfo() { resId =  ResIds.BattleUI , showLayer = UIShowLayer.Floor_0}},
        {typeof(ConfirmUI), new UIConfigInfo() {resId =  ResIds.ConfirmUI , showLayer = UIShowLayer.Top_0}},
        {typeof(MainTaskUI), new UIConfigInfo() { resId =  ResIds.MainTaskUI , showLayer = UIShowLayer.Floor_0}},
        {typeof(MainTaskStageUI), new UIConfigInfo() { resId =  ResIds.MainTaskStageUI , showLayer = UIShowLayer.Floor_0}},
        {typeof(BattleResultUI), new UIConfigInfo() { resId =  ResIds.BattleResultUI , showLayer = UIShowLayer.Floor_0}},
        {typeof(TitleBarUI), new UIConfigInfo() {resId =  ResIds.TitleBarUI , showLayer = UIShowLayer.Middle_0}},
        {typeof(TeamRoomListUI), new UIConfigInfo() { resId =  ResIds.TeamRoomListUI , showLayer = UIShowLayer.Floor_0}},
