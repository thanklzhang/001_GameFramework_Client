...
public class MainTaskStageUIShowObj : BaseUIShowObj<MainTaskStageUI>
{
    Text nameText;
    GameObject lockGo;
    Button clickBtn;
...
public class MainTaskStageUI : BaseUI
{
    ...
    {
        //列表
        UIListArgs<MainTaskStageUIShowObj, MainTaskStageUI> args = new UIListArgs<MainTaskStageUIShowObj, MainTaskStageUI>();
