...
[ExecuteInEditMode]
public class NoiseFogPostEffect : BasePostEffect
{
    [Range(0, 1)]
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        if (isSupport && material != null)
        {
            ...
            this.material.SetTexture("_NoiseTexture", noiseTexture);
            this.material.SetFloat("_FogXSpeed", fogXSpeed);
            this.material.SetFloat("_FogYSpeed", fogYSpeed);
            this.material.SetFloat("_NoiseAmount", noiseAmount);
