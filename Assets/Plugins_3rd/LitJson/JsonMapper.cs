...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        private static void AddObjectMetadata(Type type)
        {
            ...
            foreach (FieldInfo f_info in fs)
            {
                PropertyMetadata p_data = new PropertyMetadata();
                p_data.Info = f_info;
                p_data.IsField = true;
        ...
        private static object ReadValue(Type inst_type, JsonReader reader,bool isSkipFirstRead = false)
        {
            ...
            {
                ObjectMetadata t_data = new ObjectMetadata();
                if (TypeIsPolymorphismJsonAttribute(value_type))
                {
                    ...
                    //((Object) t_data).SetValue(instance, ReadValue(t, reader, true));

                    AddObjectMetadata(t);
                    t_data = object_metadata[t];
                }
                else
                {
